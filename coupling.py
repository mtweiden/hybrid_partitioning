...
if __name__ == "__main__":
    ...
    get_coupling_map("mesh", 144, True)
    get_coupling_map("mesh", 400, True)

    get_coupling_map("linear", 4, True)
    get_coupling_map("linear", 5, True)
    get_coupling_map("linear", 8, True)
    ...
    get_coupling_map("linear", 18, True)
    get_coupling_map("linear", 20, True)
    get_coupling_map("linear", 22, True)
    get_coupling_map("linear", 25, True)
    get_coupling_map("linear", 26, True)
    ...
    get_coupling_map("linear", 42, True)
    get_coupling_map("linear", 50, True)
    get_coupling_map("linear", 60, True)
    get_coupling_map("linear", 62, True)
    get_coupling_map("linear", 64, True)
    get_coupling_map("linear", 65, True)
    get_coupling_map("linear", 80, True)
    get_coupling_map("linear", 100, True)
    get_coupling_map("linear", 102, True)
    get_coupling_map("linear", 101, True)
    get_coupling_map("linear", 120, True)
    get_coupling_map("linear", 122, True)
    get_coupling_map("linear", 128, True)
    get_coupling_map("linear", 140, True)
    get_coupling_map("linear", 142, True)
